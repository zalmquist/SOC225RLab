...
Most data files you need for lab assignments should by available through Jupyter Hub. If you run into any issues accessing a needed data file, please reach out to your TA. 
...
**Question 5.2: Create a subset of dataframe `twitter_survey`, taking the first 100 rows and variables PARTY and PPWORK. Assign this object with name "my_twitter_survey".**
```{r}
